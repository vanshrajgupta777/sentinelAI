...
import { ScrollText, Search, Filter, Shield, Cpu, FileText, AlertTriangle, Database } from "lucide-react";
import { cn } from "@/lib/cn";
import type { AuditEvent } from "@/types";

const categoryFilters = ["All", "Tasks", "Documents", "AI", "Security", "RAG"] as const;
const statusFilters = ["All", "Info", "Success", "Warn", "Error"] as const;
  ...
  const filtered = useMemo(() => {
    return audit.filter((e) => {
      ...
      const matchesS =
        ...
        (statusFilter === "Error" && e.status === "ERROR");
    ...
    <li className="flex items-center gap-3 px-4 py-3">
      <div
        className={cn(
          ...
          event.category === "RAG" && "border-violet-200 text-violet-700",
